...
class Main {
  public static void main(String[] args) {
    ...
    */
    ...
    //Here's a 4 by 4 example to test
    //int[][] sillyExample  = 
    //{
     // {9, 2, 3, 5},
    //  {4, 5, 6, 5},
  ...
  /*
    ...
    for (int i = 0; i < sillyExample.length; i++)
    {
      ...
      {
        leftCol = j;
        rightCol = sillyExample[i].length-1-j;
        temp = sillyExample[i][leftCol];
        sillyExample[i][leftCol] = sillyExample[i][rightCol];
        sillyExample[i][rightCol] = temp;
      }
    }
    ...
    */
    ...
    for (int i = 0; i < sillyExample.length; i++)
    {
      for (int j=0; j < sillyExample[i].length; j++)
      {
        ...
        //right
        if ( (j+1) <= sillyExample[i].length-1 )
        {
          sum += sillyExample[i][j+1];
          count++;
        }
